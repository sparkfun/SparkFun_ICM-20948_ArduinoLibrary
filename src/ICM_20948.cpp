...
ICM_20948_Status_e ICM_20948_write_I2C(uint8_t reg, uint8_t *data, uint32_t len,
                                       void *user);
ICM_20948_Status_e ICM_20948_read_I2C(uint8_t reg, uint8_t *buff, uint32_t len,
                                      void *user);
ICM_20948_Status_e ICM_20948_write_SPI(uint8_t reg, uint8_t *buff, uint32_t len,
                                       void *user);
ICM_20948_Status_e ICM_20948_read_SPI(uint8_t reg, uint8_t *buff, uint32_t len,
                                      void *user);

// Base
ICM_20948::ICM_20948() { status = ICM_20948_init_struct(&_device); }
...
void ICM_20948::doDebugPrint(char (*funct)(const char *), const char *string,
                             bool newLine) {
        if (_printDebug == false) return;  // Bail if debugging is not enabled
...
void ICM_20948::debugPrintf(int i) {
        if (_printDebug == true) printf("%d", i);
}

void ICM_20948::debugPrintf(float f) {
        if (_printDebug == true) printf("%f", f);
}
...
void ICM_20948::debugPrintStatus(ICM_20948_Status_e stat) {
        switch (stat) {
                ...
                case ICM_20948_Stat_InvalSensor:
                        debugPrint(("Invalid Sensor"));
                        break;
                case ICM_20948_Stat_NoData:
                        debugPrint(("Data Underflow"));
                        break;
                case ICM_20948_Stat_SensorNotSupported:
                        debugPrint(("Sensor Not Supported"));
                        break;
                case ICM_20948_Stat_DMPNotSupported:
                        debugPrint(
                            ("DMP Firmware Not Supported. Is #define "
                             "ICM_20948_USE_DMP commented "
                             "in util/ICM_20948_C.h?"));
                        break;
                case ICM_20948_Stat_DMPVerifyFail:
                        debugPrint(("DMP Firmware Verification Failed"));
                        break;
                case ICM_20948_Stat_FIFONoDataAvail:
                        debugPrint(("No FIFO Data Available"));
                        break;
                case ICM_20948_Stat_FIFOIncompleteData:
                        debugPrint(("DMP data in FIFO was incomplete"));
                        break;
                case ICM_20948_Stat_FIFOMoreDataAvail:
                        debugPrint(("More FIFO Data Available"));
                        break;
                case ICM_20948_Stat_UnrecognisedDMPHeader:
                        debugPrint(("Unrecognised DMP Header"));
                        break;
                case ICM_20948_Stat_UnrecognisedDMPHeader2:
                        debugPrint(("Unrecognised DMP Header2"));
                        break;
                case ICM_20948_Stat_InvalDMPRegister:
                        debugPrint(("Invalid DMP Register"));
                        break;
                default:
...
float ICM_20948::magX(void) { return getMagUT(agmt.mag.axes.x); }

float ICM_20948::magY(void) { return getMagUT(agmt.mag.axes.y); }

float ICM_20948::magZ(void) { return getMagUT(agmt.mag.axes.z); }

float ICM_20948::getMagUT(int16_t axis_val) {
        return (((float)axis_val) * 0.15);
}

float ICM_20948::accX(void) { return getAccMG(agmt.acc.axes.x); }

float ICM_20948::accY(void) { return getAccMG(agmt.acc.axes.y); }

float ICM_20948::accZ(void) { return getAccMG(agmt.acc.axes.z); }
...
float ICM_20948::gyrX(void) { return getGyrDPS(agmt.gyr.axes.x); }

float ICM_20948::gyrY(void) { return getGyrDPS(agmt.gyr.axes.y); }

float ICM_20948::gyrZ(void) { return getGyrDPS(agmt.gyr.axes.z); }
...
ICM_20948_Status_e ICM_20948::setBiasGyroX(int32_t newValue) {
        if (_device._dmp_firmware_available == true)  // Is DMP supported?
        {
                ...
                status = inv_icm20948_write_mems(
                    &_device, GYRO_BIAS_X, 4,
...
ICM_20948_Status_e ICM_20948::getBiasGyroX(int32_t *bias) {
        if (_device._dmp_firmware_available == true)  // Is DMP supported?
        {
                ...
                status =
                    inv_icm20948_read_mems(&_device, GYRO_BIAS_X, 4, bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
                } signedUnsigned32;
                signedUnsigned32.unsigned32 = (((uint32_t)bias_data[0]) << 24) |
                                              ...
                                              (((uint32_t)bias_data[2]) << 8) |
                                              (bias_data[3]);
                *bias =
                    signedUnsigned32.signed32;  // Convert from unsigned to
                                                // signed with no cast ambiguity
                return status;
        }
        return ICM_20948_Stat_DMPNotSupported;
}
...
ICM_20948_Status_e ICM_20948::getBiasGyroY(int32_t *bias) {
        if (_device._dmp_firmware_available == true)  // Is DMP supported?
        {
                unsigned char bias_data[4] = {0};
                status =
                    inv_icm20948_read_mems(&_device, GYRO_BIAS_Y, 4, bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
                } signedUnsigned32;
...
ICM_20948_Status_e ICM_20948::getBiasGyroZ(int32_t *bias) {
        if (_device._dmp_firmware_available == true)  // Is DMP supported?
        {
                unsigned char bias_data[4] = {0};
                status =
                    inv_icm20948_read_mems(&_device, GYRO_BIAS_Z, 4, bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
                } signedUnsigned32;
...
ICM_20948_Status_e ICM_20948::getBiasAccelX(int32_t *bias) {
        ...
        {
                unsigned char bias_data[4] = {0};
                status = inv_icm20948_read_mems(&_device, ACCEL_BIAS_X, 4,
                                                bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
...
ICM_20948_Status_e ICM_20948::getBiasAccelY(int32_t *bias) {
        ...
        {
                unsigned char bias_data[4] = {0};
                status = inv_icm20948_read_mems(&_device, ACCEL_BIAS_Y, 4,
                                                bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
...
ICM_20948_Status_e ICM_20948::getBiasAccelZ(int32_t *bias) {
        ...
        {
                unsigned char bias_data[4] = {0};
                status = inv_icm20948_read_mems(&_device, ACCEL_BIAS_Z, 4,
                                                bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
...
ICM_20948_Status_e ICM_20948::getBiasCPassX(int32_t *bias) {
        ...
        {
                unsigned char bias_data[4] = {0};
                status = inv_icm20948_read_mems(&_device, CPASS_BIAS_X, 4,
                                                bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
...
ICM_20948_Status_e ICM_20948::getBiasCPassY(int32_t *bias) {
        ...
        {
                unsigned char bias_data[4] = {0};
                status = inv_icm20948_read_mems(&_device, CPASS_BIAS_Y, 4,
                                                bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
...
ICM_20948_Status_e ICM_20948::getBiasCPassZ(int32_t *bias) {
        ...
        {
                unsigned char bias_data[4] = {0};
                status = inv_icm20948_read_mems(&_device, CPASS_BIAS_Z, 4,
                                                bias_data);
                union {
                        int32_t signed32;
                        uint32_t unsigned32;
...
float ICM_20948::temp(void) { return getTempC(agmt.tmp.val); }
...
const char *ICM_20948::statusString(ICM_20948_Status_e stat) {
        ...
        switch (val) {
                ...
                case ICM_20948_Stat_SensorNotSupported:
                        ...
                        break;
                case ICM_20948_Stat_DMPNotSupported:
                        return "DMP Firmware Not Supported. Is #define "
                               "ICM_20948_USE_DMP "
                               "commented in util/ICM_20948_C.h?";
                        break;
                case ICM_20948_Stat_DMPVerifyFail:
...
ICM_20948_Status_e ICM_20948::setClockSource(
...
ICM_20948_Status_e ICM_20948::checkID(void) {
        ...
        if (status != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::checkID: ICM_20948_check_id returned: "));
...
bool ICM_20948::isConnected(void) {
        ...
        debugPrint(("ICM_20948::isConnected: checkID returned: "));
        debugPrintStatus(status);
        debugPrintln((""));
        return false;
}
...
ICM_20948_Status_e ICM_20948::setSampleMode(uint8_t sensor_id_bm,
        ...
        status = ICM_20948_set_sample_mode(
            &_device, (ICM_20948_InternalSensorID_bm)sensor_id_bm,
            (ICM_20948_LP_CONFIG_CYCLE_e)lp_config_cycle_mode);
        delay(1);  // Give the ICM20948 time to change the sample mode (see
                   // issue #8)
        return status;
}
...
ICM_20948_Status_e ICM_20948::setFullScale(uint8_t sensor_id_bm,
                                           ICM_20948_fss_t fss) {
        status = ICM_20948_set_full_scale(
            &_device, (ICM_20948_InternalSensorID_bm)sensor_id_bm, fss);
        return status;
}

ICM_20948_Status_e ICM_20948::setDLPFcfg(uint8_t sensor_id_bm,
                                         ICM_20948_dlpcfg_t cfg) {
        status = ICM_20948_set_dlpf_cfg(
            &_device, (ICM_20948_InternalSensorID_bm)sensor_id_bm, cfg);
        return status;
}

ICM_20948_Status_e ICM_20948::enableDLPF(uint8_t sensor_id_bm, bool enable) {
        status = ICM_20948_enable_dlpf(
            &_device, (ICM_20948_InternalSensorID_bm)sensor_id_bm, enable);
        return status;
}

ICM_20948_Status_e ICM_20948::setSampleRate(uint8_t sensor_id_bm,
                                            ICM_20948_smplrt_t smplrt) {
        status = ICM_20948_set_sample_rate(
            &_device, (ICM_20948_InternalSensorID_bm)sensor_id_bm, smplrt);
        return status;
}
...
ICM_20948_Status_e ICM_20948::clearInterrupts(void) {
        ...
        status = ICM_20948_execute_r(&_device, AGB0_REG_INT_STATUS,
                                     (uint8_t *)&int_stat,
                                     sizeof(ICM_20948_INT_STATUS_t));
        if (status != ICM_20948_Stat_Ok) {
                return status;
        }
        status = ICM_20948_execute_r(&_device, AGB0_REG_INT_STATUS_1,
                                     (uint8_t *)&int_stat_1,
        ...
        // todo: there may be additional interrupts that need to be cleared,
        // like FIFO overflow/watermark
...
//      All these individual functions will use a read->set->write method to
...
ICM_20948_Status_e ICM_20948::intEnableI2C(bool enable) {
        ...
        status = ICM_20948_int_enable(&_device, &en,
...
ICM_20948_Status_e ICM_20948::intEnableOverflowFIFO(uint8_t bm_enable) {
        ...
        en.FIFO_OVERFLOW_EN_0 =
            ((bm_enable >> 0) & 0x01);  // change the settings
...
ICM_20948_Status_e ICM_20948::WOMThreshold(uint8_t threshold) {
        ...
        status = ICM_20948_wom_threshold(&_device, &thr,
                                         &thr);  // write phase w/ readback
        if (status != ICM_20948_Stat_Ok) {
                return status;
        }
...
ICM_20948_Status_e ICM_20948::i2cControllerConfigurePeripheral(
    uint8_t peripheral, uint8_t addr, uint8_t reg, uint8_t len, bool Rw,
    bool enable, bool data_only, bool grp, bool swap, uint8_t dataOut) {
        status = ICM_20948_i2c_controller_configure_peripheral(
            &_device, peripheral, addr, reg, len, Rw, enable, data_only, grp,
            swap, dataOut);
        return status;
}

// Provided for backward-compatibility only. Please update to
// i2cControllerConfigurePeripheral and i2cControllerPeriph4Transaction.
// https://www.oshwa.org/2020/06/29/a-resolution-to-redefine-spi-pin-names/
ICM_20948_Status_e ICM_20948::i2cMasterConfigureSlave(
    uint8_t peripheral, uint8_t addr, uint8_t reg, uint8_t len, bool Rw,
    bool enable, bool data_only, bool grp, bool swap) {
        return (i2cControllerConfigurePeripheral(
            peripheral, addr, reg, len, Rw, enable, data_only, grp, swap, 0));
}

ICM_20948_Status_e ICM_20948::i2cControllerPeriph4Transaction(
    uint8_t addr, uint8_t reg, uint8_t *data, uint8_t len, bool Rw,
    bool send_reg_addr) {
        status = ICM_20948_i2c_controller_periph4_txn(&_device, addr, reg, data,
                                                      len, Rw, send_reg_addr);
        return status;
}
...
ICM_20948_Status_e ICM_20948::i2cMasterSLV4Transaction(uint8_t addr,
                                                       ...
                                                       uint8_t len, bool Rw,
                                                       bool send_reg_addr) {
        return (i2cControllerPeriph4Transaction(addr, reg, data, len, Rw,
                                                send_reg_addr));
}

ICM_20948_Status_e ICM_20948::i2cMasterSingleW(uint8_t addr, uint8_t reg,
                                               uint8_t data) {
...
ICM_20948_Status_e ICM_20948::startupDefault(bool minimal) {
        ...
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(("ICM_20948::startupDefault: checkID returned: "));
        ...
        retval = swReset();
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(("ICM_20948::startupDefault: swReset returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
        ...
        retval = sleep(false);
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(("ICM_20948::startupDefault: sleep returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
        ...
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(("ICM_20948::startupDefault: lowPower returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
        ...
        retval = startupMagnetometer(
            minimal);  // Pass the minimal startup flag to startupMagnetometer
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::startupDefault: startupMagnetometer "
                     "returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
        ...
        retval = setSampleMode(
            (ICM_20948_Internal_Acc | ICM_20948_Internal_Gyr),
            ICM_20948_Sample_Mode_Continuous);  // options:
                                                // ICM_20948_Sample_Mode_Continuous
                                                // or
                                                // ICM_20948_Sample_Mode_Cycled
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::startupDefault: setSampleMode returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
        ...
        retval = setFullScale((ICM_20948_Internal_Acc | ICM_20948_Internal_Gyr),
                              FSS);
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::startupDefault: setFullScale returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
        ...
        retval = setDLPFcfg((ICM_20948_Internal_Acc | ICM_20948_Internal_Gyr),
                            dlpcfg);
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::startupDefault: setDLPFcfg returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
        ...
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::startupDefault: enableDLPF (Acc) returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
        ...
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::startupDefault: enableDLPF (Gyr) returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
...
uint8_t ICM_20948::readMag(AK09916_Reg_Addr_e reg) {
        uint8_t data =
            i2cMasterSingleR(MAG_AK09916_I2C_ADDR,
                             reg);  // i2cMasterSingleR updates status too
        return data;
}
...
ICM_20948_Status_e ICM_20948::resetMag() {
        ...
        // “0”: Normal
        // “1”: Reset
        // When “1” is set, all registers are initialized. After reset, SRST bit
        // turns to “0” automatically.
        status =
            i2cMasterSingleW(MAG_AK09916_I2C_ADDR, AK09916_REG_CNTL3, SRST);
        return status;
}
...
ICM_20948_Status_e ICM_20948::enableDMP(bool enable) {
        if (_device._dmp_firmware_available ==
...
ICM_20948_Status_e ICM_20948::loadDMPFirmware(void) {
        if (_device._dmp_firmware_available ==
            true)  // Should we attempt to load the DMP firmware?
        {
...
ICM_20948_Status_e ICM_20948::setDMPstartAddress(unsigned short address) {
        if (_device._dmp_firmware_available ==
            true)  // Should we attempt to set the start address?
        {
...
ICM_20948_Status_e ICM_20948::enableDMPSensor(enum inv_icm20948_sensor sensor,
        ...
        {
                status = inv_icm20948_enable_dmp_sensor(&_device, sensor,
                                                        enable == true ? 1 : 0);
                debugPrint(
                    ("ICM_20948::enableDMPSensor:  _enabled_Android_0: "));
                debugPrintf((int)_device._enabled_Android_0);
                debugPrint(("  _enabled_Android_1: "));
                debugPrintf((int)_device._enabled_Android_1);
                debugPrint(("  _dataOutCtl1: "));
                debugPrintf((int)_device._dataOutCtl1);
                debugPrint(("  _dataOutCtl2: "));
                debugPrintf((int)_device._dataOutCtl2);
                debugPrint(("  _dataRdyStatus: "));
...
ICM_20948_Status_e ICM_20948::enableDMPSensorInt(
    enum inv_icm20948_sensor sensor, bool enable) {
        if (_device._dmp_firmware_available ==
            true)  // Should we attempt to enable the sensor interrupt?
        {
                status = inv_icm20948_enable_dmp_sensor_int(
                    &_device, sensor, enable == true ? 1 : 0);
                debugPrint(
                    ("ICM_20948::enableDMPSensorInt:  "
                     "_enabled_Android_intr_0: "));
                debugPrintf((int)_device._enabled_Android_intr_0);
                debugPrint(("  _enabled_Android_intr_1: "));
                debugPrintf((int)_device._enabled_Android_intr_1);
                debugPrint(("  _dataIntrCtl: "));
...
ICM_20948_Status_e ICM_20948::writeDMPmems(unsigned short reg,
        ...
        if (_device._dmp_firmware_available ==
            true)  // Should we attempt to write to the DMP?
        {
...
ICM_20948_Status_e ICM_20948::readDMPmems(unsigned short reg,
                                          ...
                                          unsigned char *data) {
        if (_device._dmp_firmware_available ==
            true)  // Should we attempt to read from the DMP?
        {
...
ICM_20948_Status_e ICM_20948::setDMPODRrate(enum DMP_ODR_Registers odr_reg,
        ...
        {
                // In order to set an ODR for a given sensor data, write 2-byte
                // value to DMP using key defined above for a particular sensor.
                // Setting value can be calculated as follows: Value = (DMP
                // running rate (225Hz) / ODR ) - 1 E.g. For a 25Hz ODR rate,
                // value= (225/25) - 1 = 8.

                status = inv_icm20948_set_dmp_sensor_period(&_device, odr_reg,
                                                            interval);
                return status;
        }
        return ICM_20948_Stat_DMPNotSupported;
...
ICM_20948_Status_e ICM_20948::setGyroSF(unsigned char div, int gyro_level) {
        if (_device._dmp_firmware_available ==
            true)  // Should we attempt to set the Gyro SF?
        {
                status = inv_icm20948_set_gyro_sf(&_device, div, gyro_level);
                debugPrint(("ICM_20948::setGyroSF:  pll: "));
                debugPrintf((int)_device._gyroSFpll);
                debugPrint(("  Gyro SF is: "));
...
// This function is defined as __attribute__((weak)) so you can overwrite it if
// you want to,
...
ICM_20948_Status_e ICM_20948::initializeDMP(void) {
        ...
        if (_device._dmp_firmware_available != true) {
                debugPrint(
                    ("ICM_20948::startupDMP: DMP is not available. Please "
                     "check that you "
                     "have uncommented line 29 (#define ICM_20948_USE_DMP) in "
                     "ICM_20948_C.h..."));
                return ICM_20948_Stat_DMPNotSupported;
        }
        ...
        // The ICM-20948 is awake and ready but hasn't been configured. Let's
        // step through the configuration sequence from InvenSense's
        // _confidential_ Application Note "Programming Sequence for DMP
        // Hardware Functions".
        ...
        // 0x08. Then the ICM20948's I2C_SLV0 is configured to read nine bytes
        // from the mag every sample, starting from the STATUS1 register (0x10).
        // ST1 includes the DRDY (Data Ready) bit. Next are the six magnetometer
        // readings (little endian). After a dummy byte, the STATUS2 register
        // (0x18) contains the HOFL (Overflow) bit.
        //
        // But looking very closely at the InvenSense example code, we can see
        // in inv_icm20948_resume_akm (in Icm20948AuxCompassAkm.c) that, when
        // the DMP is running, the magnetometer is set to Single Measurement
        // (SM) mode and that ten bytes are read, starting from the reserved
        // RSV2 register (0x03). The datasheet does not define what registers
        // 0x04 to 0x0C contain. There is definitely some secret sauce in
        // here... The magnetometer data appears to be big endian (not little
        // endian like the HX/Y/Z registers) and starts at register 0x04. We had
        // to examine the I2C traffic between the master and the AK09916 on the
        // AUX_DA and AUX_CL pins to discover this...
        //
        // So, we need to set up I2C_SLV0 to do the ten byte reading. The
        // parameters passed to i2cControllerConfigurePeripheral are: 0: use
        // I2C_SLV0 MAG_AK09916_I2C_ADDR: the I2C address of the AK09916
        // magnetometer (0x0C unshifted) AK09916_REG_RSV2: we start reading here
        // (0x03). Secret sauce... 10: we read 10 bytes each cycle true: set the
        // I2C_SLV0_RNW ReadNotWrite bit so we read the 10 bytes (not write
        // them) true: set the I2C_SLV0_CTRL I2C_SLV0_EN bit to enable reading
        // from the peripheral at the sample rate false: clear the I2C_SLV0_CTRL
        // I2C_SLV0_REG_DIS (we want to write the register value) true: set the
        // I2C_SLV0_CTRL I2C_SLV0_GRP bit to show the register pairing starts at
        // byte 1+2 (copied from inv_icm20948_resume_akm) true: set the
        // I2C_SLV0_CTRL I2C_SLV0_BYTE_SW to byte-swap the data from the mag
        // (copied from inv_icm20948_resume_akm)
        result = i2cControllerConfigurePeripheral(0, MAG_AK09916_I2C_ADDR,
                                                  AK09916_REG_RSV2, 10, true,
                                                  true, false, true, true);
        if (result > worstResult) worstResult = result;
        //
        // We also need to set up I2C_SLV1 to do the Single Measurement
        // triggering: 1: use I2C_SLV1 MAG_AK09916_I2C_ADDR: the I2C address of
        // the AK09916 magnetometer (0x0C unshifted) AK09916_REG_CNTL2: we start
        // writing here (0x31) 1: not sure why, but the write does not happen if
        // this is set to zero false: clear the I2C_SLV0_RNW ReadNotWrite bit so
        // we write the dataOut byte true: set the I2C_SLV0_CTRL I2C_SLV0_EN
        // bit. Not sure why, but the write does not happen if this is clear
        // false: clear the I2C_SLV0_CTRL I2C_SLV0_REG_DIS (we want to write the
        // register value) false: clear the I2C_SLV0_CTRL I2C_SLV0_GRP bit
        // false: clear the I2C_SLV0_CTRL I2C_SLV0_BYTE_SW bit
        // AK09916_mode_single: tell I2C_SLV1 to write the Single Measurement
        // command each sample
        result = i2cControllerConfigurePeripheral(
            1, MAG_AK09916_I2C_ADDR, AK09916_REG_CNTL2, 1, false, true, false,
            false, false, AK09916_mode_single);
        if (result > worstResult) worstResult = result;

        // Set the I2C Master ODR configuration
        // It is not clear why we need to do this... But it appears to be
        // essential! From the datasheet: "I2C_MST_ODR_CONFIG[3:0]: ODR
        // configuration for external sensor when gyroscope and accelerometer
        // are disabled.
        //  ODR is computed as follows: 1.1 kHz/(2^((odr_config[3:0])) )
        //  When gyroscope is enabled, all sensors (including I2C_MASTER) use
        //  the gyroscope ODR. If gyroscope is disabled, then all sensors
        //  (including I2C_MASTER) use the accelerometer ODR."
        // Since both gyro and accel are running, setting this register should
        // have no effect. But it does. Maybe because the Gyro and Accel are
        // placed in Low Power Mode (cycled)? You can see by monitoring the Aux
        // I2C pins that the next three lines reduce the bus traffic
        // (magnetometer reads) from 1125Hz to the chosen rate: 68.75Hz in this
        // case.
        result = setBank(3);
        ...
        if (result > worstResult)
                worstResult = result;  // Write one byte to the
        ...
        if (result > worstResult)
                worstResult = result;  // This is shorthand: success will be set
                                       // to false if setClockSource fails

        // Enable accel and gyro sensors through PWR_MGMT_2
        // Enable Accelerometer (all axes) and Gyroscope (all axes) by writing
        // zero to PWR_MGMT_2
        result = setBank(0);
        ...
        if (result > worstResult)
                worstResult =
                    result;  // Write one byte to the PWR_MGMT_2 register

        // Place _only_ I2C_Master in Low Power Mode (cycled) via LP_CONFIG
        // The InvenSense Nucleo example initially puts the accel and gyro into
        // low power mode too, but then later updates LP_CONFIG so only the
        // I2C_Master is in Low Power Mode
        result =
            setSampleMode(ICM_20948_Internal_Mst, ICM_20948_Sample_Mode_Cycled);
        if (result > worstResult) worstResult = result;
        ...
        ICM_20948_fss_t
            myFSS;          // This uses a "Full Scale Settings" structure that
        ...
        myFSS.g = dps2000;  // (ICM_20948_GYRO_CONFIG_1_FS_SEL_e)
                            ...
                            // dps1000
                            // dps2000
        result = setFullScale((ICM_20948_Internal_Acc | ICM_20948_Internal_Gyr),
                              myFSS);
        if (result > worstResult) worstResult = result;

        // The InvenSense Nucleo code also enables the gyro DLPF (but leaves
        // GYRO_DLPFCFG set to zero = 196.6Hz (3dB)) We found this by going
        // through the SPI data generated by ZaneL's Teensy-ICM-20948 library
        // byte by byte... The gyro DLPF is enabled by default (GYRO_CONFIG_1 =
        // 0x01) so the following line should have no effect, but we'll include
        // it anyway
        ...
        // Stop the peripheral data from being written to the FIFO by writing
        // zero to FIFO_EN_1
        result = setBank(0);
        if (result > worstResult) worstResult = result;  // Select Bank 0
        uint8_t zero = 0;
        ...
        if (result > worstResult) worstResult = result;
        // Stop the accelerometer, gyro and temperature data from being written
        // to the FIFO by writing zero to FIFO_EN_2
        ...
        mySmplrt.g = 19;  // ODR is computed as follows: 1.1
                          // kHz/(1+GYRO_SMPLRT_DIV[7:0]). 19 = 55Hz. InvenSense
                          // Nucleo example uses 19 (0x13).
        mySmplrt.a = 19;  // ODR is computed as follows: 1.125
                          // kHz/(1+ACCEL_SMPLRT_DIV[11:0]). 19 = 56.25Hz.
        ...
        result = setSampleRate(
            (ICM_20948_Internal_Acc | ICM_20948_Internal_Gyr), mySmplrt);
        if (result > worstResult) worstResult = result;
        ...
        // In order to align internal accel raw data 2^25 = 1g write 0x04000000
        // when FSR is 4g
        const unsigned char accScale[4] = {0x04, 0x00, 0x00, 0x00};
        result = writeDMPmems(ACC_SCALE, 4, &accScale[0]);
        if (result > worstResult)
                worstResult =
                    result;  // Write accScale to ACC_SCALE DMP register
        // In order to output hardware unit data as configured FSR write
        // 0x00040000 when FSR is 4g
        const unsigned char accScale2[4] = {0x00, 0x04, 0x00, 0x00};
        result = writeDMPmems(ACC_SCALE2, 4, &accScale2[0]);
        if (result > worstResult)
                worstResult =
                    result;  // Write accScale2 to ACC_SCALE2 DMP register

        // Configure Compass mount matrix and scale to DMP
        // The mount matrix write to DMP register is used to align the compass
        // axes with accel/gyro. This mechanism is also used to convert hardware
        // unit to uT. The value is expressed as 1uT = 2^30. Each compass axis
        // will be converted as below: X = raw_x * CPASS_MTX_00 + raw_y *
        // CPASS_MTX_01 + raw_z
        // * CPASS_MTX_02 Y = raw_x * CPASS_MTX_10 + raw_y * CPASS_MTX_11 +
        // raw_z * CPASS_MTX_12 Z = raw_x * CPASS_MTX_20 + raw_y * CPASS_MTX_21
        // + raw_z * CPASS_MTX_22 The AK09916 produces a 16-bit signed output in
        // the range
        ...
        const unsigned char mountMultiplierPlus[4] = {
            0x09, 0x99, 0x99,
            0x99};  // Value taken from InvenSense Nucleo example
        const unsigned char mountMultiplierMinus[4] = {
            0xF6, 0x66, 0x66,
            0x67};  // Value taken from InvenSense Nucleo example
        ...
        const unsigned char b2sMountMultiplierZero[4] = {0x00, 0x00, 0x00,
                                                         0x00};
        ...
        if (result > worstResult)
                worstResult =
                    result;  // 19 = 55Hz (see above), 3 = 2000dps (see above)
        ...
        // Configure the Accel Only Gain: 15252014 (225Hz) 30504029 (112Hz)
        // 61117001 (56Hz)
        const unsigned char accelOnlyGain[4] = {0x03, 0xA4, 0x92,
                                                0x49};  // 56Hz
        // const unsigned char accelOnlyGain[4] = {0x00, 0xE8, 0xBA, 0x2E}; //
        // 225Hz const unsigned char accelOnlyGain[4] = {0x01, 0xD1, 0x74,
        // 0x5D}; // 112Hz
        ...
        // 882002213 (56Hz)
        const unsigned char accelAlphaVar[4] = {0x34, 0x92, 0x49,
                                                0x25};  // 56Hz
        // const unsigned char accelAlphaVar[4] = {0x3D, 0x27, 0xD2, 0x7D}; //
        // 225Hz const unsigned char accelAlphaVar[4] = {0x3A, 0x49, 0x24,
        // 0x92}; // 112Hz
        result = writeDMPmems(ACCEL_ALPHA_VAR, 4, &accelAlphaVar[0]);
        if (result > worstResult) worstResult = result;

        // Configure the Accel A Var: 47721859 (225Hz) 95869806 (112Hz)
        // 191739611 (56Hz)
        ...
        // Configure the Compass Time Buffer. The I2C Master ODR Configuration
        // (see above) sets the magnetometer read rate to 68.75Hz. Let's set the
        // Compass Time Buffer to 69 (Hz).
        const unsigned char compassRate[2] = {0x00, 0x45};  // 69Hz
        result = writeDMPmems(CPASS_TIME_BUFFER, 2, &compassRate[0]);
        if (result > worstResult) worstResult = result;

                // Enable DMP interrupt
                // This would be the most efficient way of getting the DMP data,
                // instead of polling the FIFO result = intEnableDMP(true); if
                // (result > worstResult) worstResult = result;
...
ICM_20948_Status_e ICM_20948_I2C::begin(i2c *i2c, uint8_t addr, uint8_t bus) {
...
#if defined(ICM_20948_USE_DMP)
        _device._dmp_firmware_available =
        ...
        _device._last_bank =
            255;  // Initialize _last_bank. Make it invalid. It will
                  // be set by the first call of ICM_20948_set_bank.
        _device._last_mems_bank =
            255;  // Initialize _last_mems_bank. Make it invalid. It will be set
        ...
        _device._enabled_Android_0 =
            0;  // Keep track of which Android sensors are enabled: 0-31
        _device._enabled_Android_1 =
            0;  // Keep track of which Android sensors are enabled: 32-
        _device._enabled_Android_intr_0 =
            0;  // Keep track of which Android sensor interrupts are enabled:
                // 0-31
        _device._enabled_Android_intr_1 =
            0;  // Keep track of which Android sensor interrupts are enabled:
                // 32-
...
ICM_20948_Status_e ICM_20948::startupMagnetometer(bool minimal) {
        ...
        i2cMasterPassthrough(
            false);  // Do not connect the SDA/SCL pins to AUX_DA/AUX_CL
        i2cMasterEnable(true);

        resetMag();

        // After a ICM reset the Mag sensor may stop responding over the I2C
        // master Reset the Master I2C until it responds
        uint8_t tries = 0;
        while (tries < MAX_MAGNETOMETER_STARTS) {
                ...
                retval = magWhoIAm();
                if (retval == ICM_20948_Stat_Ok) break;  // WIA matched!

                i2cMasterReset();  // Otherwise, reset the master I2C and try
                                   // again
        ...
        if (tries == MAX_MAGNETOMETER_STARTS) {
                debugPrint(
                    ("ICM_20948::startupMagnetometer: reached "
                     "MAX_MAGNETOMETER_STARTS ("));
                debugPrintf((int)MAX_MAGNETOMETER_STARTS);
                debugPrintln(("). Returning ICM_20948_Stat_WrongID"));
                status = ICM_20948_Stat_WrongID;
                return status;
        } else {
                debugPrint(
                    ("ICM_20948::startupMagnetometer: successful magWhoIAm "
                     "after "));
        ...
        // Return now if minimal is true. The mag will be configured manually
        // for the DMP
        if (minimal)  // Return now if minimal is true
        {
                debugPrintln(
                    ("ICM_20948::startupMagnetometer: minimal startup "
                     "complete!"));
                return status;
        }
        ...
        reg.reserved_0 =
            0;  // Make sure the unused bits are clear. Probably redundant, but
                // prevents confusion when looking at the I2C traffic
        retval = writeMag(AK09916_REG_CNTL2, (uint8_t *)&reg);
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::startupMagnetometer: writeMag returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
                return status;
        ...
        retval = i2cControllerConfigurePeripheral(0, MAG_AK09916_I2C_ADDR,
                                                  AK09916_REG_ST1, 9, true,
                                                  true, false, false, false);
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(
                    ("ICM_20948::startupMagnetometer: "
                     "i2cMasterConfigurePeripheral "
                     "returned: "));
                debugPrintStatus(retval);
                debugPrintln((""));
                status = retval;
...
ICM_20948_Status_e ICM_20948::magWhoIAm(void) {
        ...
        // readMag calls i2cMasterSingleR which calls
        // ICM_20948_i2c_master_single_r i2cMasterSingleR updates status so it
        // is OK to set retval to status here
        retval = status;
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(("ICM_20948::magWhoIAm: whoiam1: "));
                debugPrintf((int)whoiam1);
                debugPrint((" (should be 72) readMag set status to: "));
                debugPrintStatus(status);
                debugPrintln((""));
                return retval;
        }
        ...
        if (retval != ICM_20948_Stat_Ok) {
                debugPrint(("ICM_20948::magWhoIAm: whoiam1: "));
                debugPrintf((int)whoiam1);
                debugPrint((" (should be 72) whoiam2: "));
                debugPrintf((int)whoiam2);
                debugPrint((" (should be 9) readMag set status to: "));
                debugPrintStatus(status);
                debugPrintln((""));
                return retval;
        }
        ...
        if ((whoiam1 == (MAG_AK09916_WHO_AM_I >> 8)) &&
            (whoiam2 == (MAG_AK09916_WHO_AM_I & 0xFF))) {
        ...
        debugPrint((" (should be 72) whoiam2: "));
        debugPrintf((int)whoiam2);
        debugPrintln((" (should be 9). Returning ICM_20948_Stat_WrongID"));
