...
void ICM_20948::debugPrintStatus(ICM_20948_Status_e stat) {
  ...
  case ICM_20948_Stat_DMPNotSupported:
    debugPrint(("DMP Firmware Not Supported. Is #define "
...
ICM_20948_Status_e ICM_20948::setBiasGyroX(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    status = inv_icm20948_write_mems(&_device, GYRO_BIAS_X, 4,
...
ICM_20948_Status_e ICM_20948::setBiasGyroY(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    gyro_bias_reg[2] = (unsigned char)(newValue >> 8);
    gyro_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = inv_icm20948_write_mems(&_device, GYRO_BIAS_Y, 4,
                                     (const unsigned char *)&gyro_bias_reg);
    return status;
  }
  return ICM_20948_Stat_DMPNotSupported;
...
ICM_20948_Status_e ICM_20948::setBiasGyroZ(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    gyro_bias_reg[2] = (unsigned char)(newValue >> 8);
    gyro_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = inv_icm20948_write_mems(&_device, GYRO_BIAS_Z, 4,
                                     (const unsigned char *)&gyro_bias_reg);
    return status;
  }
  return ICM_20948_Stat_DMPNotSupported;
...
ICM_20948_Status_e ICM_20948::getBiasGyroX(int32_t *bias) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    *bias = signedUnsigned32.signed32; // Convert from unsigned to
...
ICM_20948_Status_e ICM_20948::setBiasAccelX(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    status = inv_icm20948_write_mems(&_device, ACCEL_BIAS_X, 4,
...
ICM_20948_Status_e ICM_20948::setBiasAccelY(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    accel_bias_reg[2] = (unsigned char)(newValue >> 8);
    accel_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = inv_icm20948_write_mems(&_device, ACCEL_BIAS_Y, 4,
                                     (const unsigned char *)&accel_bias_reg);
    return status;
  }
  return ICM_20948_Stat_DMPNotSupported;
...
ICM_20948_Status_e ICM_20948::setBiasAccelZ(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    accel_bias_reg[2] = (unsigned char)(newValue >> 8);
    accel_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = inv_icm20948_write_mems(&_device, ACCEL_BIAS_Z, 4,
                                     (const unsigned char *)&accel_bias_reg);
    return status;
  }
  return ICM_20948_Stat_DMPNotSupported;
...
ICM_20948_Status_e ICM_20948::setBiasCPassX(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    status = inv_icm20948_write_mems(&_device, CPASS_BIAS_X, 4,
...
ICM_20948_Status_e ICM_20948::setBiasCPassY(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    cpass_bias_reg[2] = (unsigned char)(newValue >> 8);
    cpass_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = inv_icm20948_write_mems(&_device, CPASS_BIAS_Y, 4,
                                     (const unsigned char *)&cpass_bias_reg);
    return status;
  }
  return ICM_20948_Stat_DMPNotSupported;
...
ICM_20948_Status_e ICM_20948::setBiasCPassZ(int32_t newValue) {
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    ...
    cpass_bias_reg[2] = (unsigned char)(newValue >> 8);
    cpass_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = inv_icm20948_write_mems(&_device, CPASS_BIAS_Z, 4,
                                     (const unsigned char *)&cpass_bias_reg);
    return status;
  }
  return ICM_20948_Stat_DMPNotSupported;
...
ICM_20948_Status_e
ICM_20948::setClockSource(ICM_20948_PWR_MGMT_1_CLKSEL_e source) {
...
ICM_20948_Status_e ICM_20948::checkID(void) {
  ...
  if (status != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::checkID: ICM_20948_check_id returned: "));
...
ICM_20948_Status_e ICM_20948::clearInterrupts(void) {
  ...
  status =
      ICM_20948_execute_r(&_device, AGB0_REG_INT_STATUS, (uint8_t *)&int_stat,
...
ICM_20948_Status_e ICM_20948::i2cControllerConfigurePeripheral(
  ...
  status = ICM_20948_i2c_controller_configure_peripheral(
      &_device, peripheral, addr, reg, len, Rw, enable, data_only, grp, swap,
      dataOut);
  return status;
}
...
ICM_20948_Status_e ICM_20948::i2cMasterConfigureSlave(
  ...
  return (i2cControllerConfigurePeripheral(peripheral, addr, reg, len, Rw,
                                           enable, data_only, grp, swap, 0));
}

ICM_20948_Status_e
ICM_20948::i2cControllerPeriph4Transaction(uint8_t addr, uint8_t reg,
                                           uint8_t *data, uint8_t len, bool Rw,
                                           bool send_reg_addr) {
  status = ICM_20948_i2c_controller_periph4_txn(&_device, addr, reg, data, len,
                                                Rw, send_reg_addr);
  return status;
}
...
// https://www.oshwa.org/2020/06/29/a-resolution-to-redefine-spi-pin-names/
ICM_20948_Status_e
ICM_20948::i2cMasterSLV4Transaction(uint8_t addr, uint8_t reg, uint8_t *data,
                                    uint8_t len, bool Rw, bool send_reg_addr) {
  return (
      i2cControllerPeriph4Transaction(addr, reg, data, len, Rw, send_reg_addr));
}
...
uint8_t ICM_20948::i2cMasterSingleR(uint8_t addr, uint8_t reg) {
  ...
  if (status != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::i2cMasterSingleR: "
...
ICM_20948_Status_e ICM_20948::startupDefault(bool minimal) {
  ...
  if (retval != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::startupDefault: startupMagnetometer "
                "returned: "));
    debugPrintStatus(retval);
    debugPrintln((""));
    status = retval;
  ...
  {
    debugPrintln(("ICM_20948::startupDefault: minimal startup complete!"));
    return status;
  }
  ...
  if (retval != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::startupDefault: setSampleMode returned: "));
    debugPrintStatus(retval);
    debugPrintln((""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::startupDefault: setFullScale returned: "));
    debugPrintStatus(retval);
    debugPrintln((""));
    status = retval;
    return status;
  ...
  retval =
      setDLPFcfg((ICM_20948_Internal_Acc | ICM_20948_Internal_Gyr), dlpcfg);
  if (retval != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::startupDefault: setDLPFcfg returned: "));
    debugPrintStatus(retval);
    debugPrintln((""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::startupDefault: enableDLPF (Acc) returned: "));
    debugPrintStatus(retval);
    debugPrintln((""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::startupDefault: enableDLPF (Gyr) returned: "));
    debugPrintStatus(retval);
    debugPrintln((""));
    status = retval;
    return status;
...
uint8_t ICM_20948::readMag(AK09916_Reg_Addr_e reg) {
  uint8_t data = i2cMasterSingleR(MAG_AK09916_I2C_ADDR,
...
ICM_20948_Status_e ICM_20948::enableDMPSensor(enum inv_icm20948_sensor sensor,
      ...
      true) // Should we attempt to enable the sensor?
  {
    status = inv_icm20948_enable_dmp_sensor(&_device, sensor,
                                            enable == true ? 1 : 0);
    debugPrint(("ICM_20948::enableDMPSensor:  _enabled_Android_0: "));
...
ICM_20948_Status_e
ICM_20948::enableDMPSensorInt(enum inv_icm20948_sensor sensor, bool enable) {
  if (_device._dmp_firmware_available ==
      true) // Should we attempt to enable the sensor interrupt?
  {
    status = inv_icm20948_enable_dmp_sensor_int(&_device, sensor,
                                                enable == true ? 1 : 0);
    debugPrint(("ICM_20948::enableDMPSensorInt:  "
...
ICM_20948_Status_e ICM_20948::initializeDMP(void) {
  ...
  if (_device._dmp_firmware_available != true) {
    debugPrint(("ICM_20948::startupDMP: DMP is not available. Please "
                "check that you "
...
ICM_20948_Status_e ICM_20948::startupMagnetometer(bool minimal) {
  ...
  if (tries == MAX_MAGNETOMETER_STARTS) {
    debugPrint(("ICM_20948::startupMagnetometer: reached "
    ...
    debugPrint(("ICM_20948::startupMagnetometer: successful magWhoIAm "
                "after "));
  ...
  if (minimal) // Return now if minimal is true
  {
    debugPrintln(("ICM_20948::startupMagnetometer: minimal startup "
                  "complete!"));
    return status;
  }
  ...
  retval =
      i2cControllerConfigurePeripheral(0, MAG_AK09916_I2C_ADDR, AK09916_REG_ST1,
                                       9, true, true, false, false, false);
  if (retval != ICM_20948_Stat_Ok) {
    debugPrint(("ICM_20948::startupMagnetometer: "
...
ICM_20948_Status_e ICM_20948_I2C::begin(uint8_t i2cbus, uint8_t addr) {
  ...
  _device._enabled_Android_intr_0 = 0; // Keep track of which Android sensor
                                       // interrupts are enabled: 0-31
  _device._enabled_Android_intr_1 = 0; // Keep track of which Android sensor
                                       // interrupts are enabled: 32-
...
ICM_20948_Status_e ICM_20948_write_SPI(uint8_t reg, uint8_t *data, uint32_t len,
                                       void *user) {
  ICM_20948_SPI *spi_device = static_cast<ICM_20948_SPI *>(user);
